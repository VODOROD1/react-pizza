      ...
      <div className={styles.cart}>
        ...
        <div className={styles.content__items}>
          <div className={styles.cart__item}>
            ...
            <div className={styles.cart__item_count}>
              <div className={`${styles.description} ${styles.yellow}`}></div>
              <div
                className={`${styles.button} ${styles.button_outline} ${styles.button_circle} ${styles.cart__item_count_minus}`}
              >
                <svg
                  width="10"
                  height="10"
              ...
              <div
                className={`${styles.button} ${styles.button_outline}
                  ${styles.button_circle} ${styles.cart__item_count_plus}`}
              >
                <svg
                  width="10"
                  height="10"
        ...
        <div className={styles.cart__bottom}>
          ...
          <div className={styles.cart__bottom_buttons}>
            <NavLink
              to="/home"
              className={`${styles.button} ${styles.button_outline} ${styles.button_add} ${styles.go_back_btn}`}
            >
              <svg
                width="8"
                height="14"
            ...
            <div className={`${styles.button} ${styles.pay_btn}`}>
